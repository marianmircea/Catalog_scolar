		...
		<header>
			...
			<section>
				...
				<div class="form_boxes">
					<form action="php\inreg_note.php" method="post">
						...
						<p>Numar matricol  <input type="text" name="matricol"/></p>
						<p>Nota obtinuta   <select name="nota">
							<option value="1">1</option>
							<option value="2">2</option>
						...
						<p>Data acordarii  <input type="date" name="data"/></p>
						
						<p><input type="submit" value="Inregistrare"/></p>
					</form>
				</div>
			</section>	
		<footer>
